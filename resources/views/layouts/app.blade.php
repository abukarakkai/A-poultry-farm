...
<body
    class="{{ setting('theme') === 'dark' ? 'dark bg-gray-900 text-white' : 'bg-gray-100 text-gray-800' }} flex h-screen overflow-hidden">
    <!-- Sidebar -->
    <aside id="sidebar"
    ...
    <div class="flex-1 flex flex-col overflow-hidden md:ml-64">
        ...
        <div class="flex items-center justify-between px-4 md:px-8 border-b border-gray-300 py-3 bg-white">
            <button id="mobileMenuBtn"
                class="md:hidden p-2 rounded-md text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-yellow-500">
